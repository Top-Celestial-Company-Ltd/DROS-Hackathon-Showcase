...
To prevent governance-induced system collapse while maintaining strict compliance, the evaluation plane must operate within a microsecond-level latency budget. In our reference hardware implementation and empirical testbed, DROS-6P recorded an average decision latency of approximately **$26.1\ \mu\text{s}$**, demonstrating real-time, in-band policy enforcement capable of absorbing high-throughput agent Syscall streams without degrading underlying service availability.
